  ...
  return (
    <div className="screen">
        ...
        <section className="panel">
          ...
          <div className="field">
            <label className="row">
              ...
              />
              <span>
                <strong>Dry run (recommended on)</strong> — no playlists are created in Spotify.
                Turn this off only when you're ready to write to your real account.
              </span>
            </label>
          </div>
        </section>
        ...
        <section className="panel">
          ...
          <div className="field">
            ...
            <input
              ...
              onChange={(e) =>
                patchCache({ musicbrainzTtlDays: Number(e.target.value) })
              }
            />
          </div>
          <div className="field">
            ...
            <input
              ...
              onChange={(e) =>
                patchCache({ lastfmTtlDays: Number(e.target.value) })
              }
            />
          </div>
          <div className="field">
            ...
            <input
              ...
              onChange={(e) =>
                patchCache({ discogsTtlDays: Number(e.target.value) })
              }
            />
          </div>
          <div className="field">
            ...
            <input
              ...
              onChange={(e) =>
                patchCache({ wikidataTtlDays: Number(e.target.value) })
              }
            />
          </div>
        </section>
      ...
      <section className="panel">
        ...
        {cacheAction.error ? <ErrorNotice error={cacheAction.error} onRetry={cacheAction.clear} /> : null}
      ...
      <section className="panel">
        ...
        <form
          ...
          onSubmit={(e) => {
            e.preventDefault();
            const input = (e.currentTarget.elements.namedItem("destPath") as HTMLInputElement)
              .value;
